...
if("TRUE" STREQUAL "TRUE")
  set(hector_imu_tools_SOURCE_PREFIX /home/husarion/slam2/src/hector_slam/hector_imu_tools)
  set(hector_imu_tools_DEVEL_PREFIX /home/husarion/slam2/devel)
  ...
  set(hector_imu_tools_INSTALL_PREFIX /home/husarion/slam2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husarion/slam2/src/hector_slam/hector_imu_tools/${idir}'.  ${_report}")
    endif()
