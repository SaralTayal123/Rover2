...
if("TRUE" STREQUAL "TRUE")
  set(roboclaw_SOURCE_PREFIX /home/husarion/slam2/src/roboclaw)
  set(roboclaw_DEVEL_PREFIX /home/husarion/slam2/devel)
  set(roboclaw_INSTALL_PREFIX "")
  set(roboclaw_PREFIX ${roboclaw_DEVEL_PREFIX})
else()
  set(roboclaw_SOURCE_PREFIX "")
  set(roboclaw_DEVEL_PREFIX "")
  set(roboclaw_INSTALL_PREFIX /home/husarion/slam2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboclaw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husarion/slam2/src/roboclaw/${idir}'.  ${_report}")
    endif()
