...
if("TRUE" STREQUAL "TRUE")
  set(roboclaw_SOURCE_PREFIX /home/ubuntu/Rover2/src/roboclaw)
  set(roboclaw_DEVEL_PREFIX /home/ubuntu/Rover2/devel)
  set(roboclaw_INSTALL_PREFIX "")
  set(roboclaw_PREFIX ${roboclaw_DEVEL_PREFIX})
else()
  set(roboclaw_SOURCE_PREFIX "")
  set(roboclaw_DEVEL_PREFIX "")
  set(roboclaw_INSTALL_PREFIX /home/ubuntu/Rover2/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Saral Tayal <saraltayal@outlook.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'roboclaw' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'roboclaw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Rover2/src/roboclaw/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT roboclaw_NUM_DUMMY_TARGETS)
      set(roboclaw_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::roboclaw::wrapped-linker-option${roboclaw_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR roboclaw_NUM_DUMMY_TARGETS "${roboclaw_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::roboclaw::wrapped-linker-option${roboclaw_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND roboclaw_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${roboclaw_dep}_FOUND)
      find_package(${roboclaw_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${roboclaw_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
